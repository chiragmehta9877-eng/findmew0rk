...
export default function JobDetailsPage() {
  ...
  const handleApplyClick = () => {
    // Backend call to increment click
    fetch('/api/track', {
        method: 'POST',
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-[#112240] rounded-2xl border border-gray-200 dark:border-white/5 shadow-sm p-6 sticky top-24">
               ...
               <a 
                 ...
                 className="block w-full bg-[#0a66c2] hover:bg-blue-700 text-white text-center font-bold py-3 rounded-xl transition-all shadow-lg hover:shadow-blue-500/30 mb-3 cursor-pointer"
               >
                 Apply Now
               </a>
               
               <a href={applyUrl} target="_blank" rel="noopener noreferrer" onClick={handleApplyClick} className="flex items-center justify-center gap-2 w-full border border-gray-200 dark:border-white/10 text-slate-700 dark:text-gray-300 font-bold py-3 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
